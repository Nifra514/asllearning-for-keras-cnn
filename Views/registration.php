...
<div class="well">
    ...
    <form class="form-horizontal" action="registration_submit.php" method="POST">
        ...
        <div class="form-group">
            <div class=" col-md-12">
                <label style="color: #ff0000;"><input type="checkbox" name="con" value="Yes" required="Please Accept Our Terms & Conditions!"> I Agree To The Terms & Conditions Of ASL Learning</label>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class=" col-md-12">
                <br>
                <input type="submit" id="register" value="Register" name="register"	class="btn btn-primary form-control">
            </div>
        </div>
    </form>
